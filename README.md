...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-hgnchelper-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12650&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-hgnchelper-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-hgnchelper` can be installed with:

```
conda install r-hgnchelper
```

It is possible to list all of the versions of `r-hgnchelper` available on your platform with:
